...
const ComingSoonModal = () => {
	...
	const form = useForm<z.infer<typeof FormSchema>>({
		...
		defaultValues: {
			user_email: "",
			message:
				"Hi,i just signed up to join the Company-Name when you launch!, please notify me when you launch",
		},
	});
					...
					<section className="flex flex-col items-center gap-6 md:w-1/2 ">
						<div>
							...
							<h2 className="max-w-[38.875rem] text-center text-[1.18rem] font-[500] leading-[2.2rem] text-secondary-2 md:text-[1.3rem] md:leading-[2rem] xxl:max-w-[45.875rem]  xxl:text-[1.3rem]">
								Sign up to our mailing list to be the first to know when we
								launch!
							</h2>
						</div>
						...
						<a
							href="mailto:support@jointheCompany-Name.com"
